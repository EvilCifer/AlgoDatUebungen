...
public class TestSuite {
	...
	public static void main(String[] args) {
		MengeAlsListeAlsRingDynBin<Integer> menge = new MengeAlsListeAlsRingDynBin<Integer>();
		System.out.println("---------------Blatt_8 - Aufgabe_02 TestSuite---------------");
		System.out.println();
		...
		System.out.println("insert(10):\tfalse\t\t\t" + menge.insert(10));
